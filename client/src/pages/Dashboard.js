...
function Dashboard() {
  ...
  return (
    <div>
            ...
            <div style={{ textAlign: "center" }}>
              {users.map((user) => (
                <div
                  ...
                  onClick={() => {
                    personalData(user._id);
                  }}
                >
                  <div style={{ display: "flex" }}>
                    <img
                      src={`${CONSTANTS.API_URL}uploads/${user.profile}`}
                      alt="img"
                      style={{
                        margin: "auto 5px",
                        height: "3rem",
                  ...
                  <div style={{ margin: "auto 50px" }}>
                    <button
                      style={{ padding: "15px 5px" }}
                      disabled={room.some((Items) => Items == user._id)}
                      onClick={() => {
                        createChat(user._id);
                      }}
                    >
            ...
            <div>
              ...
              <form onSubmit={submit}>
                <div style={{ display: "flex" }}>
                  <label>Profile: </label>
                  <img
                    src={`${CONSTANTS.API_URL}uploads/${settings.profile}`}
                    style={{
                      height: "4rem",
                      width: "4rem",
                      borderRadius: "100%",
      ...
      <div
        style={{ marginLeft: "320px", padding: "5px", position: "relative" }}
      >
